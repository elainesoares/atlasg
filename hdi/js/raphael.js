        ...
        tuneText = function (el, params) {
            ...
            if (params[has]("text")) {
                ...
                for (var i = 0, ii = texts[length]; i < ii; i++) if (texts[i]) {
                    ...
                    if(texts != lang_mng.getString("arvore_semdados") && texts != lang_mng.getString("arvore_idhm") && texts != lang_mng.getString("arvore_renda") && texts != lang_mng.getString("arvore_longevidadetr") && texts != lang_mng.getString("arvore_edu")){
                        texts[i] = texts[i]/100;
                        if(texts != '0.1' && texts != '0.2' && texts != '0.3' && texts != '0.4' && texts != '0.5' && texts != '0.6' && texts != '0.7' && texts != '0.8' && texts != '0.9' && texts != '1'){
                            texts[i] = texts[i].toFixed(3);
                        }
                        texts[i] = texts[i].toString();
