...
function graficoFluxoEscolar() {
    ...
    dados.addColumn('number',array_freq_esc_5a6[0].label_ano_referencia);
...
function graficoDesenvolvimentoHumanoIDHM_EN() {
    var dados = new google.visualization.DataTable();
    ...
    try{            
        ...
        dados.addColumn('string','Data');
        dados.addRows(array_renda.length);
        dados.addColumn('number',"Income");
        dados.addColumn('number',"Longevity");
        dados.addColumn('number',"Education");
...
function graficoEscolaridadePop91_EN() {
    var dados = new google.visualization.DataTable(); 
    var array_1991 = Array();
    var array_valor_1991 = Array();
    var array_nome_1991 = Array();
    ...
    {  
		if('T_ANALF25M' == array_1991[i].sigla ){
            array_nome_1991.push("Illiterate");
            array_valor_1991.push(array_1991[i].valor);
        }
		
        if('T_FUND25M' == array_1991[i].sigla ){
            array_nome_1991.push("Having completed primary education");
            array_valor_1991.push(array_1991[i].valor - medio);               
        }
        if('T_SUPER25M' == array_1991[i].sigla){		
			array_nome_1991.push("Having completed secondary education");
            array_valor_1991.push(medio - array_1991[i].valor);
			
            array_nome_1991.push("Having completed higher education");
            array_valor_1991.push(array_1991[i].valor);
        }      
    }
...
function graficoEscolaridadePop00_EN() {
    var dados = new google.visualization.DataTable(); 
    var array_2000 = Array();
    var array_valor_2000 = Array();
    var array_nome_2000 = Array();
    ...
    {  
		if('T_ANALF25M' == array_2000[i].sigla ){
            array_nome_2000.push("Illiterate");
            array_valor_2000.push(array_2000[i].valor);
        }
		
        if('T_FUND25M' == array_2000[i].sigla ){
            array_nome_2000.push("Having completed primary education");
            array_valor_2000.push(array_2000[i].valor - medio);
        }
        if('T_SUPER25M' == array_2000[i].sigla){	                
            array_nome_2000.push("Having completed secondary education");
            array_valor_2000.push(medio - array_2000[i].valor );        
			
            array_nome_2000.push("Having completed higher education");
            array_valor_2000.push(array_2000[i].valor);
        }      
    }
...
function graficoEscolaridadePop10_EN() {
    var dados = new google.visualization.DataTable(); 
    var array_2010 = Array();
    var array_valor_2010 = Array();
    var array_nome_2010 = Array();
    ...
    {  
		if('T_ANALF25M' == array_2010[i].sigla ){
            array_nome_2010.push("Illiterate");
            array_valor_2010.push(array_2010[i].valor);
        }
		
        if('T_FUND25M' == array_2010[i].sigla ){
            array_nome_2010.push("Having completed primary education");
            array_valor_2010.push(array_2010[i].valor - medio);
                      
        }
        if('T_SUPER25M' == array_2010[i].sigla){
			array_nome_2010.push("Having completed secondary education");
            array_valor_2010.push(medio - array_2010[i].valor); 
			
            array_nome_2010.push("Having completed higher education");
            array_valor_2010.push(array_2010[i].valor);
        }      
    }
...
function graficoEvolucaoIDHM_EN() {
    var dados = new google.visualization.DataTable(); 
    var array = Array();
    var array_max_min = Array();
    var array_media_brasil = Array();
    ...
    var idh = array[0].nome;
    var maior_idh = 'Highest (MHDI)';
    var menor_idh = 'Lowest (MHDI)';
    var nac_idh = 'Brazilian average';
    var uf_idh = 'Average of the municipality: '+ array_media_estado[0].nome;
    ...
    width: 800, 
    height: 500,
    title:"MHDI evolution - "+array[0].nome+" - "+array_media_estado[0].uf,
    hAxis: {
        viewWindow: {
            max: 2010,
            min: 1990
...
function graficoFaixaEtaria1991_EN() {
    ...
    array_idade.push('0 to 4','5 to 9','10 to 14','15 to 19','20 to 24','25 to 29',
        '30 to 34','35 to 39','40 to 44','45 to 49','50 to 54','55 to 59','60 to 64',
        '65 to 69','70 to 74','75 to 79','80 to +');
    ...
    dados.addColumn('string','Data');
    dados.addRows(array_idade.length);
    dados.addColumn('number','Men');
    dados.addColumn('number','Women');
...
function graficoFaixaEtaria2000_EN() {
    var dados = new google.visualization.DataTable();
    var array_masc = Array();
    var array_femin = Array();
    var array_idade = new Array();
...
function graficoFaixaEtaria2010_EN() {
    var dados = new google.visualization.DataTable();
    var array_masc = Array();
    var array_femin = Array();
    var array_idade = new Array();
...
//----------------------------------------------GRAFICO FLUXO ESCOLAR------------------------------//
function graficoFluxoEscolar_EN() {
    var dados = new google.visualization.DataTable(); 
    var array_freq_esc_5a6 = Array();
    var array_freq_esc_11a13 = Array(); 
    var array_freq_esc_15a17 = Array();
    ...
    chart.draw(dados, {
        ...
        title:"The educational flow of young people - "+array_freq_esc_5a6[0].nome+" - "+array_freq_esc_5a6[0].uf

    });
}
//-------------------------------------FREQUENCIA ESCOLAR ---------------------------------------//

function graficoFrequenciaEscolarDe15a17Anos_EN() {
    ...
    for(i=0;i<array.length;i++)
    {
        ...
        if('T_FREQ15A17' == array[i].sigla ){
            array_freq_esc_15a17_nome.push("Not attending school");
            array_freq_esc_15a17_valor.push(100 - array[i].valor);
        }
    }
    ...
    for(i=0;i<array.length;i++)
    {
        ...
        if('T_ATRASO_0_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Attending secondary school without delay"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
		else if('T_FREQFUND1517' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Attending primary school");
            array_freq_esc_15a17_valor.push(array[i].valor);
        }
        else if('T_ATRASO_1_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Attending secondary school with a 1-year delay"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_2_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Attending secondary school with a 2-year delay"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_FREQSUPER1517' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Attending school of higher education");
            array_freq_esc_15a17_valor.push(array[i].valor);
        }
    }
    var valor = 100;
    ...
    array_freq_esc_15a17_nome.push("Others");
    if(valor < 0){
		array_freq_esc_15a17_valor.push(Number(0));
    }else{
		array_freq_esc_15a17_valor.push(Number(valor));
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"School attendance of young people aged 15 to 17 years - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
                
}

function graficoFrequenciaEscolarDe18a24Anos_EN() {
    ...
    {
		if('T_FREQ18A24' == array[i].sigla ){
		array_freq_esc_18a24_nome.push("Not attending");
		array_freq_esc_18a24_valor.push(100 - array[i].valor);
        }
    }
    ...
    {        
        if('T_FREQFUND1824' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Attending primary school");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
        else if('T_FREQMED1824' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Attending secondary school");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
        else if('T_FLSUPER' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Attending higher education institution");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
    }
    var valor = 100;
    ...
    array_freq_esc_18a24_nome.push("Others");
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"School attendance of young adults aged 18 to 24 years - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
                
}

function graficoFrequenciaEscolarDe6a14Anos_EN() {
    var dados = new google.visualization.DataTable(); 
    var array = Array();
    var array_freq_esc_6a14_nome = Array();
    var array_freq_esc_6a14_valor = Array();
    ...
    for(i=0;i<array.length;i++)
    {
        if('T_FLFUND' == array[i].sigla){
            ...
            array_freq_esc_6a14_nome.push("Not attending");
            array_freq_esc_6a14_valor.push(100 - array[i].valor);
        }
    }
    ...
    {
        if('T_ATRASO_0_FUND' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Attending primary school without delay"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_1_FUND' == array [i].sigla){
            array_freq_esc_6a14_nome.push("Attending primary school with a 1-year delay"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_2_FUND' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Attending primary school with a 2-year delay"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_FREQMED614' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Attending secondary school");
            array_freq_esc_6a14_valor.push(array[i].valor);
        }    
    ...
    array_freq_esc_6a14_nome.push("Others");
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"School attendance of children aged 6 to 14 years - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
...
function graficoFrequenciaEscolar_EN() {
    var dados = new google.visualization.DataTable(); 
    var array_freq_esc_mun = Array();
    var array_freq_esc_uf = Array(); 
    var array_freq_esc_pais = Array();
    ...
    dados.addColumn('number',array_freq_esc_mun[0].nome);
    dados.addColumn('number','State: ' + array_freq_esc_uf[0].uf);
    dados.addColumn('number','Brazil');
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 600,
        title:"The educational flow of young people - "+array_freq_esc_mun[0].nome+" - "+array_freq_esc_uf[0].uf+" - 2010" 
...
function graficoTaxaCrescimentoIDHM_EN() {
    var dados = new google.visualization.DataTable(); 
    var array = Array();
    var array_media_brasil = Array();
    var array_media_estado = Array();
...
function graficoTrabalho_EN() {
    ...
    array_valor_trab_2010.push((t_ativ18m/100)*peso18);
    array_nome_trab_2010.push("Economically-active population");

    array_valor_trab_2010.push(peso18 - (((t_ativ18m/100)*peso18)));
    array_nome_trab_2010.push("Economically-inactive population");
...
function graficoTrabalhoAtivos_EN() {
    ...
    dados.addColumn('number','Employed');
    dados.addColumn('number','Unemployed');
...
function graficoDesenvolvimentoHumanoIDHM_ES() {
    var dados = new google.visualization.DataTable();
    ...
    try{            
        ...
        dados.addColumn('string','Data');
        dados.addRows(array_renda.length);
        dados.addColumn('number',"Ingreso");
        dados.addColumn('number',"Longevidad");
        dados.addColumn('number',"Educación");
...
function graficoEscolaridadePop91_ES() {
    var dados = new google.visualization.DataTable(); 
    var array_1991 = Array();
    var array_valor_1991 = Array();
    var array_nome_1991 = Array();
    ...
    {  
        ...
        if('T_FUND25M' == array_1991[i].sigla ){
            array_nome_1991.push("Con primaria completa");
            array_valor_1991.push(array_1991[i].valor - medio);               
        }
        if('T_SUPER25M' == array_1991[i].sigla){		
			array_nome_1991.push("Secundaria completa");
            array_valor_1991.push(medio - array_1991[i].valor);
...
function graficoEscolaridadePop00_ES() {
    var dados = new google.visualization.DataTable(); 
    var array_2000 = Array();
    var array_valor_2000 = Array();
    var array_nome_2000 = Array();
    ...
    {  
        ...
        if('T_FUND25M' == array_2000[i].sigla ){
            array_nome_2000.push("Con primaria completa");
            array_valor_2000.push(array_2000[i].valor - medio);
        }
        if('T_SUPER25M' == array_2000[i].sigla){	                
            array_nome_2000.push("Secundaria completa");
            array_valor_2000.push(medio - array_2000[i].valor );        
...
function graficoEscolaridadePop10_ES() {
    var dados = new google.visualization.DataTable(); 
    var array_2010 = Array();
    var array_valor_2010 = Array();
    var array_nome_2010 = Array();
    ...
    {  
        ...
        if('T_FUND25M' == array_2010[i].sigla ){
            array_nome_2010.push("Con primaria completa");
            array_valor_2010.push(array_2010[i].valor - medio);
                      
        }
        if('T_SUPER25M' == array_2010[i].sigla){
			array_nome_2010.push("Secundaria completa");
            array_valor_2010.push(medio - array_2010[i].valor); 
...
function graficoEvolucaoIDHM_ES() {
    var dados = new google.visualization.DataTable(); 
    var array = Array();
    var array_max_min = Array();
    var array_media_brasil = Array();
    ...
    var idh = array[0].nome;
    var maior_idh = 'Mayor IDHM';
    var menor_idh = 'Menor IDHM';
    var nac_idh = 'Promedio de Brasil';
    var uf_idh = 'Promedio del estado: '+ array_media_estado[0].nome;
    ...
    width: 800, 
    height: 500,
    title:"Evolución del IDHM - "+array[0].nome+" - "+array_media_estado[0].uf,
    hAxis: {
        viewWindow: {
            max: 2010,
            min: 1990
...
function graficoFaixaEtaria1991_ES() {
    ...
    dados.addColumn('string','Data');
    dados.addRows(array_idade.length);
    dados.addColumn('number','Hombres');
    dados.addColumn('number','Mujeres');
...
function graficoFaixaEtaria2000_ES() {
    var dados = new google.visualization.DataTable();
    var array_masc = Array();
    var array_femin = Array();
    var array_idade = new Array();
...
function graficoFaixaEtaria2010_ES() {
    var dados = new google.visualization.DataTable();
    var array_masc = Array();
    var array_femin = Array();
    var array_idade = new Array();
...
//----------------------------------------------GRAFICO FLUXO ESCOLAR------------------------------//
function graficoFluxoEscolar_ES() {
    ...
    chart.draw(dados, {
        ...
        title:"Flujo escolar por rango de edad - " + array_freq_esc_5a6[0].nome+" - "+array_freq_esc_5a6[0].uf

    });
}
//-------------------------------------FREQUENCIA ESCOLAR ---------------------------------------//

function graficoFrequenciaEscolarDe15a17Anos_ES() {
    ...
    for(i=0;i<array.length;i++)
    {
        ...
        if('T_FREQ15A17' == array[i].sigla ){
            array_freq_esc_15a17_nome.push("No asiste");
            array_freq_esc_15a17_valor.push(100 - array[i].valor);
        }
    }
    ...
    for(i=0;i<array.length;i++)
    {
        ...
        if('T_ATRASO_0_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Cursa la educación secundaria sin retraso"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
		else if('T_FREQFUND1517' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Cursa la educación primaria");
            array_freq_esc_15a17_valor.push(array[i].valor);
        }
        else if('T_ATRASO_1_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Cursa la educación secundaria con un año de retraso"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_2_MED' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Cursa la educación secundaria con dos años de retraso"); 
            array_freq_esc_15a17_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_FREQSUPER1517' == array[i].sigla){
            array_freq_esc_15a17_nome.push("Cursa la educación superior");
            array_freq_esc_15a17_valor.push(array[i].valor);
        }
    }
    var valor = 100;
    ...
    array_freq_esc_15a17_nome.push("Otros");
    if(valor < 0){
		array_freq_esc_15a17_valor.push(Number(0));
    }else{
		array_freq_esc_15a17_valor.push(Number(valor));
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"Asistencia escolar de 15 a 17 años - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
                
}

function graficoFrequenciaEscolarDe18a24Anos_ES() {
    ...
    {
		if('T_FREQ18A24' == array[i].sigla ){
		array_freq_esc_18a24_nome.push("No asiste");
		array_freq_esc_18a24_valor.push(100 - array[i].valor);
        }
    }
    ...
    {        
        if('T_FREQFUND1824' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Cursa la educación primaria");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
        else if('T_FREQMED1824' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Cursa la educación secundaria");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
        else if('T_FLSUPER' == array[i].sigla){
            array_freq_esc_18a24_nome.push("Cursa la educación superior");
            array_freq_esc_18a24_valor.push(array[i].valor);
        }
    }
    var valor = 100;
    ...
    array_freq_esc_18a24_nome.push("Otros");
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"Asistencia escolar de 18 a 24 años - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
                
}

function graficoFrequenciaEscolarDe6a14Anos_ES() {
    var dados = new google.visualization.DataTable(); 
    var array = Array();
    var array_freq_esc_6a14_nome = Array();
    var array_freq_esc_6a14_valor = Array();
    ...
    for(i=0;i<array.length;i++)
    {
        if('T_FLFUND' == array[i].sigla){
            ...
            array_freq_esc_6a14_nome.push("No asiste");
            array_freq_esc_6a14_valor.push(100 - array[i].valor);
        }
    }
    ...
    {
        if('T_ATRASO_0_FUND' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Primaria sin retraso"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_1_FUND' == array [i].sigla){
            array_freq_esc_6a14_nome.push("Primaria con un año de retraso"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_ATRASO_2_FUND' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Primaria con dos años de retraso"); 
            array_freq_esc_6a14_valor.push((array[i].valor * taxa_frequencia)/100);
        }
        else if('T_FREQMED614' == array[i].sigla){
            array_freq_esc_6a14_nome.push("Cursa la educación secundaria");
            array_freq_esc_6a14_valor.push(array[i].valor);
        }    
    ...
    array_freq_esc_6a14_nome.push("Otros");
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 400,
        title:"Asistencia escolar de 6 a 14 años - "+array[0].nome+" - "+array[0].uf+" - 2010"
    });
...
function graficoFrequenciaEscolar_ES() {
    var dados = new google.visualization.DataTable(); 
    var array_freq_esc_mun = Array();
    var array_freq_esc_uf = Array(); 
    var array_freq_esc_pais = Array();
    ...
    chart.draw(dados, {
        ...
        width: 800, 
        height: 600,
        title:"Flujo escolar por rango de edad - "+array_freq_esc_mun[0].nome+" - "+array_freq_esc_uf[0].uf+" - 2010" 
...
function graficoTaxaCrescimentoIDHM_ES() {
...
function graficoTrabalho_ES() {
    ...
    array_valor_trab_2010.push((t_ativ18m/100)*peso18);
    array_nome_trab_2010.push("Población económicamente activa");

    array_valor_trab_2010.push(peso18 - (((t_ativ18m/100)*peso18)));
    array_nome_trab_2010.push("Población económicamente no activa");
...
function graficoTrabalhoAtivos_ES() {
