...
class PerfilRM extends bd {
    ...
    public function drawBoxes() {
        ...
        $tabela->addBox("Faixa do IDHM", Formulas::getSituacaoIDH($idhm));
    ...
    public function drawScripts() {
        ...
        <script type="text/javascript">
            ...
            var baseUrl = "<?php echo PATH_DIRETORIO; ?>" + lang + "/perfil_rm/";
            var storedName = "";
                    
            
            splited = document.URL.split(lang_mng.getString("lang_id")+"/perfil_rm/");
