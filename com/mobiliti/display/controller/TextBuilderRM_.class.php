...
class TextBuilderRM {
    ...
    static public function generateIDH_componente($block_componente) {
        ...
        if (TextBuilderRM::$print){ 
            $block_componente->setData("quebra", "<div style='page-break-after: always'></div>");
        }else
            $block_componente->setData("quebra", "");
        
        $block_componente->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_componente->setData("titulo", "IDHM"); //@Translate
        $block_componente->setData("subtitulo", "Componentes"); //@Translate
        $block_componente->setData("canvasContent", getChartDesenvolvimentoHumano(TextBuilderRM::$idMunicipio));        
        $block_componente->setData("info", "");

        $idhm = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM"); //IDHM
        $idhm_r = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_R"); //IDHM_R
        $idhm_l = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_L"); //IDHM_L
        $idhm_e = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_E"); //IDHM_E
        ...
        $texto->replaceTags("municipio", TextBuilderRM::$nomeMunicipio);
        $texto->replaceTags("idh", Formulas::getIDH2010($idhm));
        
        $texto->replaceTags("Faixa_DH", Formulas::getSituacaoIDH($idhm));

        $texto->replaceTags("Dimensao2000a2010", Formulas::getDimensao($idhm_r, $idhm_l, $idhm_e, array("faixa0010" => true, "faixa9100" => false)));
        $texto->replaceTags("Dimensao1991a2000", Formulas::getDimensao($idhm_r, $idhm_l, $idhm_e, array("faixa0010" => false, "faixa9100" => true)));
    ...
    static public function generateIDH_table_componente($block_table_componente) {
        ...
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_E")); //IDHM Educação
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND18M")); //"% de 18 ou mais anos com fundamental completo"
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FREQ5A6")); //% de 5 a 6 anos na escola
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND11A13")); //% de 12 a 14 anos nos anos finais do fundamental
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND15A17")); //% de 16 a 18 anos com fundamental completo
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_MED18A20")); //% de 19 a 21 anos com médio completo
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_L")); //IDHM Longevidade
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "ESPVIDA")); //Esperança de vida ao nascer
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM_R")); //IDHM Renda
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "RDPC")); //Renda per capita
        ...
        $block_table_componente->setData("fonte", TextBuilderRM::$fontePerfil);        
        $block_table_componente->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
    ...
    static public function generateIDH_evolucao($block_evolucao) {
        ...
        $idhm = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "IDHM"); //IDHM
        $idhm_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "IDHM"); //IDHM do Estado
        $idhm_brasil = TextBuilderRM::getVariaveis_Brasil(TextBuilderRM::$idMunicipio, "IDHM"); //IDHM do Brasil

        $block_evolucao->setData("subtitulo", "Evolução");//@Translate
        $block_evolucao->setData("fonte", TextBuilderRM::$fontePerfil);
        //----------------------------------------------------------------------------------------
        ...
        $texto1->replaceTags("municipio", TextBuilderRM::$nomeMunicipio);
        ...
        if (Formulas::getReducaoHiato0010($idhm) >= 0)
        ...
        $texto2->replaceTags("municipio", TextBuilderRM::$nomeMunicipio);
        ...
        if (Formulas::getReducaoHiato9100($idhm) >= 0)
        ...
        $texto3->replaceTags("municipio", TextBuilderRM::$nomeMunicipio);
        ...
        if (Formulas::getReducaoHiato9110($idhm) >= 0)
        ...
        $block_evolucao->setData("canvasContent", getChartEvolucao(TextBuilderRM::$idMunicipio));
    }
    ...
    static public function generateIDH_table_taxa_hiato($block_table_taxa_hiato) {
        ...
        $block_table_taxa_hiato->setData("fonte", TextBuilderRM::$fontePerfil);
    ...
    static public function generateIDH_ranking($block_ranking) {
        ...
        $ranking = TextBuilderRM::getRanking(); //IDHM
        $uf = TextBuilderRM::getUf(TextBuilderRM::$idMunicipio); //IDHM
        $ranking_uf = TextBuilderRM::getRankingUf($uf[0]["id"]); //IDHM
        ...
        if (TextBuilderRM::$idMunicipio != 735){
            //@Translate
    ...
    static public function generateDEMOGRAFIA_SAUDE_populacao($block_populacao) {
        ...
        $pesotot = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESOTOT"); //PESOTOT
        $pesourb = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESOURB"); //PESORUR
        $pesotot_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "PESOTOT"); //PESOTOT do Estado
        $pesotot_brasil = TextBuilderRM::getVariaveis_Brasil(TextBuilderRM::$idMunicipio, "PESOTOT"); //PESOTOT do Brasil        
        //$pesorur = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESORUR"); //PESORUR        
        ...
        $block_populacao->setData("fonte", TextBuilderRM::$fontePerfil);
    ...
    static public function generateIDH_table_populacao($block_table_populacao) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESOTOT")); //População Total
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "HOMEMTOT")); //Homens
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "MULHERTOT")); //Mulheres
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESOURB")); //População Urbana
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESORUR")); //População Rural
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "")); //Taxa de Urbanização
        ...
        $block_table_populacao->setData("fonte", TextBuilderRM::$fontePerfil);        
        $block_table_populacao->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
        $block_table_populacao->setData("coluna1", "População");//@Translate
        $block_table_populacao->setData("coluna2", "% do Total");//@Translate
        
        Formulas::printTablePopulacao($block_table_populacao, $variaveis);
        
    }

    static public function generateDEMOGRAFIA_SAUDE_etaria($block_etaria) {

        $tenv = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ENV"); //T_ENV
        $rd = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "RAZDEP"); //T_ENV
    ...
    static public function generateIDH_table_etaria($block_table_etaria) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESO15")); //Menos de 15 anos (PESOTOT-PESO15)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "")); //15 a 64 anos
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PESO65")); //65 anos ou mais
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "RAZDEP")); //Razão de Dependência(Planilha Piramide)               
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ENV")); //Índice de Envelhecimento
        ...
        $block_table_etaria->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_table_etaria->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
        ...
        $block_table_etaria->setData("canvasContent1", getChartPiramideEtaria1(TextBuilderRM::$idMunicipio));
        $block_table_etaria->setData("canvasContent2", getChartPiramideEtaria2(TextBuilderRM::$idMunicipio));    
        $block_table_etaria->setData("canvasContent3", getChartPiramideEtaria3(TextBuilderRM::$idMunicipio));
        
    }

    static public function generateDEMOGRAFIA_SAUDE_longevidade1($block_longevidade) {

        $mort1 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "MORT1"); //MORT1
        $mort1_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "MORT1"); //MORT1 do Estado
        $mort1_brasil = TextBuilderRM::getVariaveis_Brasil(TextBuilderRM::$idMunicipio, "MORT1"); //MORT1 do Brasil
        ...
        if (Formulas::getMortalidadeInfantil10($mort1) <= Formulas::getMortalidadeInfantil00($mort1))
            $texto1->replaceTags("mort1_diminuiu_aumentou", "reduziu");//@Translate
        else if (Formulas::getMortalidadeInfantil10($mort1) > Formulas::getMortalidadeInfantil00($mort1))
    ...
    static public function generateIDH_table_longevidade($block_table_longevidade) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "ESPVIDA")); //Esperança de vida ao nascer (anos)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "MORT1")); //Mortalidade até 1 ano de idade (por mil nascidos vivos)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "MORT5")); //Mortalidade até 5 anos de idade (por mil nascidos vivos)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "FECTOT")); //Taxa de fecundidade total (filhos por mulher) 
        ...
        $block_table_longevidade->setData("fonte", TextBuilderRM::$fontePerfil);        
        $block_table_longevidade->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
       ...
       static public function generateDEMOGRAFIA_SAUDE_longevidade2($block_longevidade) {
        ...
        $espvida = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "ESPVIDA"); //ESPVIDA
        $espvida_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "ESPVIDA"); //ESPVIDA do Estado
        $espvida_brasil = TextBuilderRM::getVariaveis_Brasil(TextBuilderRM::$idMunicipio, "ESPVIDA"); //ESPVIDA do Brasil
    ...
    static public function generateEDUCACAO_nivel_educacional($block_nivel_educacional) {
        ...
        $t_freq4a6 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FREQ5A6"); //T_FREQ5A6 - Mudou variável
        $t_fund12a14 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND11A13");  //T_FUND11A13 - Mudou variável
        $t_fund16a18 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND15A17");  //T_FUND15A17 - Mudou variável
        $t_med19a21 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_MED18A20");  //T_MED18A20 - Mudou variável
        
        $t_atraso_0_fund = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ATRASO_0_FUND");  //T_ATRASO_0_FUND 
        $t_flfund = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FLFUND");  //T_FLFUND 

        $t_atraso_0_med = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ATRASO_0_MED");  //T_ATRASO_0_MED 
        $t_flmed = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FLMED");  //T_FLMED 
        $t_flsuper = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FLSUPER");  //T_FLSUPER 

        $t_freq6a14 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FREQ6A14");  //T_FREQ6A14 
        $t_freq15a17 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FREQ15A17");  //T_FREQ15A17 
        //$t_freq18a24 = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FREQ18A24");  //T_FREQ15A17 
        ...
        $block_nivel_educacional->setData("fonte", TextBuilderRM::$fontePerfil);
        ...
        $block_nivel_educacional->setData("canvasContent1", getChartFluxoEscolar(TextBuilderRM::$idMunicipio));
        ...
        $block_nivel_educacional->setData("canvasContent2", getChartFrequenciaEscolar(TextBuilderRM::$idMunicipio));
        ...
        $block_nivel_educacional->setData("canvasContent3", getChartFrequenciaDe6a14(TextBuilderRM::$idMunicipio));              
        $block_nivel_educacional->setData("canvasContent4", getChartFrequenciaDe15a17(TextBuilderRM::$idMunicipio));
        $block_nivel_educacional->setData("canvasContent5", getChartFrequenciaDe18a24(TextBuilderRM::$idMunicipio));
    ...
    static public function generateEDUCACAO_populacao_adulta($block_populacao_adulta) {
        ...
        $t_analf25m = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ANALF18M"); //T_ANALF18M - Mudou variável
        $t_fundin25m = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUND18M");  //T_FUND18M  - Mudou variável
        $t_medin25m = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_MED18M");  //T_MED18M  - Mudou variável
        
        $t_fundin25m_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "T_FUND18M");  //T_FUND18M - Mudou variável
        $t_medin25m_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "T_MED18M");  //T_MED18M - Mudou variável
        
        $e_anosesperados = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "E_ANOSESTUDO"); //E_ANOSESTUDO
        $e_anosesperados_uf = TextBuilderRM::getVariaveis_Uf(TextBuilderRM::$idMunicipio, "E_ANOSESTUDO");  //E_ANOSESTUDO
               
        $uf = TextBuilderRM::getUf(TextBuilderRM::$idMunicipio); //UF
        
        $block_populacao_adulta->setData("subtitulo", "População Adulta");//@Translate
        $block_populacao_adulta->setData("fonte", TextBuilderRM::$fontePerfil);
        ...
        $block_populacao_adulta->setData("canvasContent", getChartEscolaridadePopulacao(TextBuilderRM::$idMunicipio));
    ...
    static public function generateRENDA($block_renda) {
        ...
        $rdpc = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "RDPC"); //RDPC  
        $pind = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PIND");  //PIND 
        $pop = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "POP");  //POP 
        $gini = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "GINI");  //GINI 
        ...
        $block_renda->setData("fonte", TextBuilderRM::$fontePerfil);
        ...
        //TODO: Tirar o igual da comparação (feito pq a base não é oficial e há replicações
        if (Formulas::getRenda10($rdpc) >= Formulas::getRenda91($rdpc))
            $texto->replaceTags("caiu_cresceu", "cresceu");//@Translate
        else if (Formulas::getRenda10($rdpc) < Formulas::getRenda91($rdpc))
        ...
        if (Formulas::getGini10($gini) < Formulas::getGini91($gini))
            $texto->replaceTags("diminuiu_aumentou", "diminuiu");//@Translate
        else if (Formulas::getGini10($gini) == Formulas::getGini91($gini))
            $texto->replaceTags("diminuiu_aumentou", "se manteve");//@Translate
        else if (Formulas::getGini10($gini) > Formulas::getGini91($gini))
            $texto->replaceTags("diminuiu_aumentou", "aumentou");//@Translate
    ...
    static public function generateIDH_table_renda($block_table_renda) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "RDPC")); //Renda per capita média (R$ de 2010)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PIND")); //Proporção de extremamente pobres - total (%)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PMPOB")); //Proporção de pobres 
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "GINI")); //Índice de Gini

        $block_table_renda->setData("titulo", "");
        $block_table_renda->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_table_renda->setData("caption", "Renda, Pobreza e Desigualdade");//@Translate
        $block_table_renda->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
    ...
    static public function generateIDH_table_renda2($block_table_renda2) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PREN20")); //20% mais pobres
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PREN40")); //40% mais pobres
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PREN60")); //60% mais pobres
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PREN80")); //80% mais pobres
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PREN20RICOS")); //20% mais ricos

        $block_table_renda2->setData("titulo", "");
        $block_table_renda2->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_table_renda2->setData("caption", "Porcentagem da Renda Apropriada por Estratos da População");//@Translate
        $block_table_renda2->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
    ...
    static public function generateTRABALHO1($block_trabalho) {
        ...
        $t_ativ18m = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ATIV18M"); //T_ATIV18M  
        $t_des18m = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_DES18M");  //T_DES18M 
        ...
        $block_trabalho->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_trabalho->setData("titulo", "Trabalho");//@Translate
        $block_trabalho->setData("canvasContent", getChartTrabalho(TextBuilderRM::$idMunicipio));
    ...
    static public function generateIDH_table_trabalho($block_table_trabalho) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ATIV18M")); //Taxa de atividade
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_DES18M")); //Taxa de desocupação
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_FORMAL")); //Grau de formalização dos ocuupados
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_FUND")); //% de empregados com fundamental completo
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_MED")); //% de empregados com médio completo
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "REN1")); //% com até 1 s.m. 
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "REN2")); //% com até 2 s.m. 
        //array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "THEILtrab")); //% Theil dos rendimentos do trabalho  

        $block_table_trabalho->setData("titulo", "");
        $block_table_trabalho->setData("fonte", TextBuilderRM::$fontePerfil);
        ...
        $block_table_trabalho->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
    ...
    static public function generateTRABALHO2($block_trabalho) {
        ...
        $p_agro = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_AGRO");  //P_AGRO 
        $p_extr = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_EXTR");  //P_EXTR
        $p_transf = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_TRANSF");  //P_TRANSF
        $p_constr = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_CONSTR"); //P_CONSTR
        $p_siup = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_SIUP");  //P_SIUP
        $p_com = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_COM");  //P_COM
        $p_serv = TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "P_SERV");  //P_SERV
    ...
    static public function generateHABITACAO($block_habitacao) {
        ...
        $block_habitacao->setData("fonte", TextBuilderRM::$fontePerfil);
    ...
    static public function generateIDH_table_habitacao($block_table_habitacao) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_AGUA")); //água encanada
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_LUZ")); //energia elétrica
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_LIXO")); //coleta de lixo*

        $block_table_habitacao->setData("titulo", "");
        $block_table_habitacao->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_table_habitacao->setData("caption", "Indicadores de Habitação");//@Translate
        $block_table_habitacao->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
        
        Formulas::printTableHabitacao($block_table_habitacao, $variaveis);
    ...
    static public function generateVULNERABILIDADE($block_vulnerabilidade) {
        ...
        $block_vulnerabilidade->setData("fonte", TextBuilderRM::$fontePerfil);
    ...
    static public function generateIDH_table_vulnerabilidade($block_table_vulnerabilidade) {
        ...
        $variaveis = array();
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "MORT1")); //Mortalidade infantil
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FORA4A5")); //Percentual de pessoas de 4 a 5 anos de idade fora da escola
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FORA6A14")); //Percentual de pessoas de 6 a 14 anos de idade fora da escola
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_NESTUDA_NTRAB_MMEIO")); //Percentual de pessoas de 15 a 24 anos de idade que não estuda e não trabalha e cuja renda per capita <½  salário mínimo
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_M10A14CF")); //Percentual de mulheres de 10 a 14 anos de idade que tiveram filhos
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_M15A17CF")); //Percentual de mulheres de 15 a 17 anos de idade que tiveram filhos
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_ATIV1014")); //Taxa de atividade de crianças e jovens que possuem entre 10 e 14 anos de idade
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_MULCHEFEFIF014")); //Percentual de mães chefes de família sem fundamental completo com filhos menores de 15 anos 
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_RMAXIDOSO")); //Percentual de pessoas em domicílios com renda per capita < ½ salário mínimo e cuja principal renda é de pessoa com 65 anos ou mais
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PINDCRI")); //Percentual de crianças que vivem em extrema pobreza, ou seja, em domicílios com renda per capita abaixo de R% 70,00.
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "PPOB")); //#XXPercentual de pessoas em domicílios com renda per capita inferior a R$ 225,00 (1/2 salário mínimo em agosto/2010)
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "T_FUNDIN18MINF")); //Percentual de pessoas de 18 anos ou mais sem fundamental completo e em ocupação informal
        array_push($variaveis, TextBuilderRM::getVariaveis_table(TextBuilderRM::$idMunicipio, "AGUA_ESGOTO")); //Percentual de pessoas em domicílios cujo abastecimento de água não seja por rede geral ou esgotamento sanitário não realizado por rede coletora de esgoto ou fossa séptica
        ...
        $block_table_vulnerabilidade->setData("fonte", TextBuilderRM::$fontePerfil);
        $block_table_vulnerabilidade->setData("t", "");
        $block_table_vulnerabilidade->setData("caption", "Vulnerabilidade Social");//@Translate
        $block_table_vulnerabilidade->setData("municipio", TextBuilderRM::$nomeMunicipio . " - " . TextBuilderRM::$ufMunicipio);
    ...
    static function getVariaveis_table($municipio, $variavel) {
        ...
        $SQL = "SELECT label_ano_referencia, lang_var.nomecurto,  lang_var.nome_perfil, valor
                ...
                WHERE fk_municipio = $municipio and sigla like '$variavel' and lang like '". TextBuilderRM::$lang ."'
                 ORDER BY label_ano_referencia";

        //echo $SQL . "<br><br>"; 
        return TextBuilderRM::$bd->ExecutarSQL($SQL, "getVariaveis_table");
    }
    ...
    static function getVariaveis_Uf($municipio, $variavel) {
        ...
        return TextBuilderRM::$bd->ExecutarSQL($SQL, "getVariaveis_Uf");
    }
    ...
    static function getVariaveis_Brasil($municipio, $variavel) {
        ...
        return TextBuilderRM::$bd->ExecutarSQL($SQL, "getVariaveis_Brasil");
    }
    ...
    static function getRanking() {
        ...
        return TextBuilderRM::$bd->ExecutarSQL($SQL, "getRanking");
    }
    ...
    static function getIDHM_Igual($idhm) {
        ...
        return TextBuilderRM::$bd->ExecutarSQL($SQL, "getIDHM_Igual");
    }
