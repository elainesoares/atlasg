...
//        console.log('startSelector');
        ...
        html += '<button class="gray_button big_bt btn_clean" type="button" style="font-size: 14px; height: 30px; margin-left: 20px;">' + lang_mng.getString("limpar_selecionados") + '</button><div>';
        html += '</div>';
