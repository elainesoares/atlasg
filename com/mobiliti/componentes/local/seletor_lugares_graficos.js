...
function LocalSelectorG()
{
    ...
    this.startSelector = function(multiselect, id_element_context, listener_param, orientation, _to_hide, skip)
    {
        ...
        html += '<button class=" gray_button big_bt btn_clean" type="button" style="margin-left: 20px; font-size: 14px; height: 30px;">' + lang_mng.getString("limpar_selecionados") + '</button><div>';
        html += '</div>';
