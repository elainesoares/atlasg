...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $("#ui_button_zoomin").attr("data-original-title",lang_mng.getString("mapa_zoomin"));
        $("#ui_button_zoomout").attr("data-original-title",lang_mng.getString("mapa_zoomout"));
        $("#uimaptool_zoomout").attr("data-original-title",lang_mng.getString("mapa_brasil"));
        $("#uimaptool_selectregion").attr("data-original-title",lang_mng.getString("mapa_regiao"));
        $("#uimap_show_legend").attr("data-original-title",lang_mng.getString("mapa_legenda"));
        $("#uimap_show_perfil").attr("data-original-title",lang_mng.getString("mapa_miniperfil"));
        $("#link_quintil").attr("data-original-title",lang_mng.getString("mapa_qtool"));
        $("#link_quintil").html(lang_mng.getString("mapa_quintil"));
        $("#link_quintil_voltar").html(lang_mng.getString("mapa_voltar"));
        $("#link_quintil_voltar").attr("data-original-title",lang_mng.getString("mapa_voltar_msg"));
        $('#m_leg_title').html(lang_mng.getString("mapa_leg").toUpperCase());
        $('#img_lg_idhm').attr("src",lang_mng.getString("mapa_idh_img"));
        $('#uimap_popover_perfil_link').html(lang_mng.getString("mapa_exibir_perfil"));
        //----
    ...
    function map_update_popover(popdata)
    {
        if (popdata.id)
        {
            ...
            if (popdata.estado)
            {
                ...
                $("#p_title").val(lang_mng.getString("mapa_municipio"));
            }
            else
            {
                $("#uimap_popover_espc_name").html(popdata.title);
                $("#p_nome_local").val(popdata.title);
                $("#p_title").val(lang_mng.getString("mapa_estado"));
            }
            ...
            if (popdata.estado)
            {
                var show_by_lang = false;
                <?php
                      if(perfil_has_lang($_SESSION["lang"]))  echo "show_by_lang = true;";     
                ?>
                                
                if(show_by_lang)
                {
                   $("#uimap_popover_perfil_link").attr("href", lang_mng.getString("lang_id") + "/perfil/" + popdata.perfil);
                        ...
                        <td style="padding: 0; margin: 0; border: 0;">
                            ...
                            <div style='position:relative; top:10px; left:0px;'>
                                ...
                                <div id="uimap_legend" style="background-color: white; position:absolute; height: 155px; top:455px; left:3px; width: 130px; background-color: white; border: 3px solid #c0c0c0;"> 
                                    ...
                                    <div id="m_leg_title" style="position: relative; left: 6px; font-size: 12px; font-weight: bold;">LEGENDA</div>
                                ...
                                <div class="btn-group btn-group-vertical" style="position:absolute; top:4px; left:600px;">
                                    ...
                                    <div></div>
                                    <button id="uimaptool_selectregion" data-original-title='Selecionar região' title data-placement='left' type="button" class="btn" data-toggle="button" style="height:31px; width: 42px;"><img style="height: 16px; width: 16px" src="img/map/zoom_select_gray.png" /></button>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="height: 32px; width: 32px; border:0px; margin:0px; padding: 0px; vertical-align: middle; text-align:left; color:#808080; font-weight: bold;"> 
                                                    <img id="img_lg_idhm" style="height: 32px; width: 32px;" src="img/map/idhm.png" alt="" /> 
                                                </td>
                                            ...
                                            <tr>
                                                <td style="height: 32px; width: 32px; border:0px; margin:0px; padding: 0px;"> 
                                                    <img style="height: 32px; width: 32px;" src="img/map/idh_longevidade.png" alt="" /> 
                                                </td>
                                            ...
                                            <tr>
                                                <td style="height: 32px; width: 32px; border:0px; margin:0px; padding: 0px;" > 
                                                    <img style="height: 32px; width: 32px;" src="img/map/idh_renda.png" alt="" /> 
                                                </td>
                                            ...
                                            <tr>
                                                <td style="height: 32px; width: 32px; border:0px; margin:0px; padding: 0px;"> 
                                                    <img style="height: 32px; width: 32px;" src="img/map/idh_educacao.png" alt=""/> 
                                                </td>
