    ...
    try{
        ...
        $.ajax({
            ...
            data:{
                ...
                'json_lang':lang_mng.getString("lang_id")
            },
...
function fillEnptyTabela(){
    ...
    if(!t_geral)
        ...
        $("#staticThead_1").append("<th class='th_1 th_2' >"+
            ...
            "<a id=\"area_btnPesquisaTabela\" data-placement=\"bottom\" class=\"height\" rel=\"popover\">"+
            "<input type='text' class='open2 customInputTabela' id='btnPesquisaTabela' i='0' in='2' value='"+storedText2+"'/></a>"+
            "</div><div style='display:none' id='Conten_btnPesquisaTabela'>"+
            "<div style='text-align:center'></div>"+
...
function fillTabela(json){
    ...
    if(t > 0)
        $("#staticThead_1").append("<th class='th_hover th_1 th_2' >"+
            ...
            "<div class='btnInputSearch' id='area_inpt_btnPesquisaTabela'>"+
            "<a id=\"area_btnPesquisaTabela\" data-placement=\"bottom\" class=\"height\" rel=\"popover\">"+
            "<input type='text' class='open2 customInputTabela'  value='"+storedText2+"' id='btnPesquisaTabela' i='0' in='2' /></a>"+
            "</div><div style='display:none' id='Conten_btnPesquisaTabela'>"+
            "<div style='text-align:center'></div>"+
            "</div><i class=\"icon-search customIconTabela\"></i></th>");
    else{
    ...
    for(var i in json)
    {
        ...
        for(var k in json[i].vs){
            ...
            $("#staticThead_1").append("<th class='th_hover' tdId='"+k+"'>"+
                "<div id='remove_"+k+"' class=\"customRemoveColumn\" data-original-title='' title data-placement='bottom' onclick=\"removerColuna("+json[i].vs[k].iv+","+json[i].vs[k].ka+",'"+tbObjetoConsulta['nomevariaveis'][json[i].vs[k].iv].sigla+"','"+k+"',"+index+");\"></div>"+
