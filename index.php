...
//        console.log('novaPagina');
        ...
        if(!t_geral){
            $("#alertTabela").html('<div class="alert alert-warnning"><button type="button" class="close" data-dismiss="alert">&times;</button>Antes de realizar o download selecione pelo menos uma espacialidade e um indicador.</div>');
            return;
        }
        ...
        <div class="containerTitlePage">
            ...
            <div class="iconAtlas">
                ...
                <div class="inIconAtlas">
                    ...
                    <form method="post" action="imprimir_mapa/" target="_blank" id="form_mapa_print">
                    ...
                    <form method="post" action="consulta/download/" target="_blank" id="form2">
                        ...
                        <button class="gray_button big_bt" id="imgTab6" data-original-title='Download da lista em formato csv (compatível com o Microsoft Excel e outras planilhas eletrônicas).' title data-placement='bottom' icon="download_2" onclick="novaPagina(2)">
